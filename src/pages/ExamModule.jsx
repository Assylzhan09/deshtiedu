...
const ExamModule = ({ t }) => {
    ...
    return (
        <Fragment>
            ...
            {/* complete data */}
            <Modal centered visible={ExamCompleteModal} onOk={() => setExamCompleteModalModal(false)} onCancel={() => setExamCompleteModalModal(false)} footer={null} className="custom_modal_notify self-modal">
