...
const AudioQuestions = ({ t }) => {
    ...
    const handleChangeCategory = (data) => {
        ...
        if (data.no_of != "0") {
            ...
            navigate({ pathname: "/AudioQuestionsPlay" });
            Loadtempdata(data);
        }
    };
                    ...
                    <div className="row morphisam mb-5">
                        ...
                        <div className="col-xxl-9 col-xl-8 col-lg-8 col-md-12 col-12">
                            <div className="right-sec">
                                <AudioQuestionsSlider data={subCategory.all} selected={subCategory.selected} url={`/AudioQuestionsPlay`} Questionsloader={subloading} />
                            </div>
                        </div>
                    </div>
                </div>
