...
const Footer = ({ t }) => {
    ...
    if (redirect === 1) {
        return <Navigate to={{ pathname: "/privacy-policy" }} />;
    } else if (redirect === 2) {
    ...
    if (comredirect === 1) {
        return <Navigate to={{ pathname: "/about-us" }} />;
    } else if (comredirect === 2) {
        return <Navigate to={{ pathname: "/contact-us" }} />;
    }
                    ...
                    <div className="row">
                        <div className="col-md-6 col-lg-3  col-12 footer_left">
                            <div className="footer_logo">
                                <Logo image={process.env.PUBLIC_URL + `/images/logo/footerlogo.svg`} />
                            </div>
