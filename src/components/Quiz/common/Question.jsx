...
import { getbookmarkApi, leveldataApi, levelDataApi, setbookmarkApi, UserCoinScoreApi, UserStatisticsApi } from "../../../store/actions/campaign";
    ...
    const setNextQuestion = () => {
        ...
        if (nextQuestion < questions.length) {
            ...
            if (percentage >= Number(systemconfig.maximum_coins_winning_percentage)) {
                ...
                UserCoinScoreApi(coins,userScore,null,"Quiz Win",status,(response) => {
                ...
                UserCoinScoreApi(null,userScore,null,"Quiz Win",status,(response) => {
                        updateUserDataInfo(response.data);
                    },
                    (error) => {
                        console.log(error);
